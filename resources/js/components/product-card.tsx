            ...
            <div className={`min-w-0 flex-1 ${view === 'grid' ? 'pt-4' : ''}`}>
                <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                        ...
                        <p className="mt-1 text-lg font-bold tracking-tight text-blue-700 dark:text-blue-400">{formatCurrency(Number(product.sale_price))}</p>
                    </div>
